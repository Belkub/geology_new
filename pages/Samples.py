...
try:
    ...
    ##            
            ...
            now = datetime.now()
            new_row_1 = {'КПАВ':['КПАВ'], 'Тип КПАВ':['Тип КПАВ'], 'ММ':['ММ'], 'Эквивалент, г/кг':['Эквивалент, г/кг'], 'Способ':['Способ'], 'КПАВ/Бент, г/кг':['КПАВ/Бент, г/кг'], 'ПК/Бент, г/кг':['ПК/Бент, г/кг'], 'Растворитель':['Растворитель'], 'ф600':['ф600'], 'ф300':['ф300'], 'GEL1/10':['GEL1/10'], 'Brookfield':['Brookfield'], 'ф600 БС':['ф600 БС'], 'ф300 БС':['ф300 БС'], 'GEL БС':['GEL БС'], 'Примечания':['Примечания']}
        ...
        if st.button('Создать новый образец'):
            ...
            new_row = {'Время':now, 'Имя образца':[text], 'Номер':[g], 'Бентонит': [t_1], 'КПАВ':[''], 'Тип КПАВ':[''], 'ММ':[''], 'Эквивалент, г/кг':[''], 'Способ':[''], 'КПАВ/Бент, г/кг':[''], 'ПК/Бент, г/кг':[''], 'Растворитель':[''], 'ф600':[''], 'ф300':[''], 'YP':[''], 'PV':[''], 'GEL1/10':[''], 'Brookfield':[''], 'ф600 БС':[''], 'ф300 БС':[''], 'YP БС':[''], 'PV БС':[''], 'n':[''], 'K':[''], 'LSRV':[''], 'GEL БС':[''], 'Примечания':['']}
